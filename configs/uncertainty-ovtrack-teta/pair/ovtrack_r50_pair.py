model = dict(
    ...
    roi_head=dict(
        ...
        use_cls_static_ratio=False, # todo used to mix the classification features.
        cls_static_ratio=0.1, # todo used to mix the classification features.
        ...
        track_head=dict(
            ...
            num_convs=4,
            num_fcs=1,
            embed_channels=512, # ori: 256, # uncertainty design: make it alignment with the classification head todo
...
# 1. detpro after softmax finetune best result only by complete and incomplete prompt
# load_from = '/home/clark/workspace2/detpro/workdirs/vild_use_complete_to_train_without_complete_test_after_softmax_0002/epoch_1.pth'
# 2. detpro after softmax fintune epoch1 by  "complete", "incomplete", # "blur", "clear", "occluded", "unoccluded", "obscured", "unobscured", "recognizable", "unrecognizable" mean leanrning
# load_from = '/home/clark/workspace2/detpro/workdirs/vild_use_promptgroup_to_train_without_promptgroup_test_after_softmax_0002/epoch_1.pth'
# 3. the same setting as beblow but without level crop
# load_from = '/data1/clark/models/detpro/workdirs/vild_use_promptgroup_to_train_no_level_crop_without_promptgroup_test_after_softmax_0002/epoch_1.pth'
# load_from = '/data1/clark/models/detpro/workdirs/vild_use_promptgroup_to_train_level_crop_without_promptgroup_test_after_softmax_0002_reverse/epoch_1.pth'
load_from = '/data1/clark/models/detpro/workdirs/vild_use_promptgroup_to_train_without_promptgroup_reverse_04_07_test/epoch_1.pth'
...
evaluation = dict(metric=['track'], start=9999, interval=1, resfile_path='results/save_eval_self_train_cyc_repair_matching_relations_999')
...
log_level = 'INFO'
resume_from = None
# resume_from = '/home/clark/workspace2/ovtrack/work_dirs/ovtrack_train_by_detpro_epoch18_after_softmax_1e-4/epoch_6.pth'
workflow = [('train', 1)]
gpu_ids = range(0,8)
