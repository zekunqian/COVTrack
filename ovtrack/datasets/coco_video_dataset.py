...
class CocoVideoDataset(CocoDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.is_select_ori_img = is_select_ori_img
    ...
    def prepare_train_img(self, idx):
        ...
        # print(f"[{rank}/{world_size}] [1] taodataset get: {img_info['file_name']}, {ref_img_info['file_name']}")
        ...
        # print(f"[{rank}/{world_size}] [2] taodataset before pipeline: {img_info['file_name']}, {ref_img_info['file_name']}")
